...
You can follow these two processes (Checking Situational Conflicts](checking situational conflicts) and [`checking-situational-conflicts`](#checking-insufficiency)), to reproduce all our results using he four case studies available in [the case-study folder](case-studies/).
