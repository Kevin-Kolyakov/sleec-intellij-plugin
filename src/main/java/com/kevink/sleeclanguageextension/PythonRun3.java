...
public class PythonRun3 extends AnAction {
    ...
    private static final String MAIN_SCRIPT_RESOURCE = "scripts/runSleec3.py";
     ...
     *  - Run: python scripts/runSleec3.py <temp_content_file>
