...
public class SleecNumExpImpl extends ASTWrapperPsiElement implements SleecNumExp {

  public SleecNumExpImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public SleecNumBinOp getNumBinOp() {
    return findChildByClass(SleecNumBinOp.class);
  }

  @Override
  @Nullable
  public SleecNumTerminal getNumTerminal() {
    return findChildByClass(SleecNumTerminal.class);
  }
