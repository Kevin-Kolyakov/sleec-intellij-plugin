...
public class SleecScalarNameImpl extends ASTWrapperPsiElement implements SleecScalarName {

  public SleecScalarNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SleecVisitor visitor) {
    visitor.visitScalarName(this);
  }
