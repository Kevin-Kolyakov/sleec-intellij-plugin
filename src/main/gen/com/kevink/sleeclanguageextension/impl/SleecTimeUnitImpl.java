...
public class SleecTimeUnitImpl extends ASTWrapperPsiElement implements SleecTimeUnit {

  public SleecTimeUnitImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SleecVisitor visitor) {
    visitor.visitTimeUnit(this);
  }
