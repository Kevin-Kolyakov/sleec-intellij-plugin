...
public class SleecPurposeBlockImpl extends ASTWrapperPsiElement implements SleecPurposeBlock {

  public SleecPurposeBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SleecVisitor visitor) {
    visitor.visitPurposeBlock(this);
  }
  ...
  @Override
  @NotNull
  public List<SleecPurpose> getPurposeList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SleecPurpose.class);
  }
