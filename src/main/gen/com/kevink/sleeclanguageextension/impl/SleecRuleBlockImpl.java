...
public class SleecRuleBlockImpl extends ASTWrapperPsiElement implements SleecRuleBlock {

  public SleecRuleBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SleecRule> getRuleList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SleecRule.class);
  }
