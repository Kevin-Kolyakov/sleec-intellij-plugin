...
public class SleecScaleRuleImpl extends ASTWrapperPsiElement implements SleecScaleRule {

  public SleecScaleRuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SleecVisitor visitor) {
    visitor.visitScaleRule(this);
  }
