...
public class SleecExtendedResponseImpl extends ASTWrapperPsiElement implements SleecExtendedResponse {

  public SleecExtendedResponseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SleecVisitor visitor) {
    visitor.visitExtendedResponse(this);
  }
