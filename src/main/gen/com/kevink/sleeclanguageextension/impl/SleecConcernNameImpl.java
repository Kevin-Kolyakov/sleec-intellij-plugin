...
public class SleecConcernNameImpl extends ASTWrapperPsiElement implements SleecConcernName {

  public SleecConcernNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SleecVisitor visitor) {
    visitor.visitConcernName(this);
  }
