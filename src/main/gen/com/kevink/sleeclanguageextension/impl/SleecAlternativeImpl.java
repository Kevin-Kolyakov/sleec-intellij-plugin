...
public class SleecAlternativeImpl extends ASTWrapperPsiElement implements SleecAlternative {

  public SleecAlternativeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public SleecInnerResponse getInnerResponse() {
    return findNotNullChildByClass(SleecInnerResponse.class);
  }
