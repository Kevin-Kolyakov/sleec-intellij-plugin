...
public class SleecMBoolExprImpl extends ASTWrapperPsiElement implements SleecMBoolExpr {

  public SleecMBoolExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SleecVisitor visitor) {
    visitor.visitMBoolExpr(this);
  }
  ...
  @Override
  @NotNull
  public SleecBoolExp getBoolExp() {
    return findNotNullChildByClass(SleecBoolExp.class);
  }
