...
public class SleecConcernBlockImpl extends ASTWrapperPsiElement implements SleecConcernBlock {

  public SleecConcernBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SleecVisitor visitor) {
    visitor.visitConcernBlock(this);
  }
  ...
  @Override
  @NotNull
  public List<SleecConcern> getConcernList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SleecConcern.class);
  }
