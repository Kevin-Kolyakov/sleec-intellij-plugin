...
public class SleecScaleParamImpl extends ASTWrapperPsiElement implements SleecScaleParam {

  public SleecScaleParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SleecVisitor visitor) {
    visitor.visitScaleParam(this);
  }
