...
public class SleecBooleanRuleImpl extends ASTWrapperPsiElement implements SleecBooleanRule {

  public SleecBooleanRuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SleecVisitor visitor) {
    visitor.visitBooleanRule(this);
  }
