...
public class SleecNumericRuleImpl extends ASTWrapperPsiElement implements SleecNumericRule {

  public SleecNumericRuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SleecVisitor visitor) {
    visitor.visitNumericRule(this);
  }
