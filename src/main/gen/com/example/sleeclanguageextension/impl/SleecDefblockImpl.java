...
public class SleecDefblockImpl extends ASTWrapperPsiElement implements SleecDefblock {

  public SleecDefblockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<SleecDefinition> getDefinitionList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SleecDefinition.class);
  }
