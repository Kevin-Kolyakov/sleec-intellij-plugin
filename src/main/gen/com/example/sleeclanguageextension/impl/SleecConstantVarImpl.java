...
public class SleecConstantVarImpl extends ASTWrapperPsiElement implements SleecConstantVar {

  public SleecConstantVarImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SleecVisitor visitor) {
    visitor.visitConstantVar(this);
  }
