...
public class SleecBoolTerminalImpl extends ASTWrapperPsiElement implements SleecBoolTerminal {

  public SleecBoolTerminalImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SleecVisitor visitor) {
    visitor.visitBoolTerminal(this);
  }
  ...
  @Override
  @Nullable
  public SleecBoolValue getBoolValue() {
    return findChildByClass(SleecBoolValue.class);
  }
