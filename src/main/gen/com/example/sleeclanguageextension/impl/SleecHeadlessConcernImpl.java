...
public class SleecHeadlessConcernImpl extends ASTWrapperPsiElement implements SleecHeadlessConcern {

  public SleecHeadlessConcernImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SleecVisitor visitor) {
    visitor.visitHeadlessConcern(this);
  }
