...
public class SleecNumTerminalImpl extends ASTWrapperPsiElement implements SleecNumTerminal {

  public SleecNumTerminalImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SleecVisitor visitor) {
    visitor.visitNumTerminal(this);
  }
