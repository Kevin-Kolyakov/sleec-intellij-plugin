...
public class SleecBoolExpValueImpl extends ASTWrapperPsiElement implements SleecBoolExpValue {

  public SleecBoolExpValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SleecVisitor visitor) {
    visitor.visitBoolExpValue(this);
  }
