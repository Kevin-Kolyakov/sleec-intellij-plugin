...
public class SleecNumNameImpl extends ASTWrapperPsiElement implements SleecNumName {

  public SleecNumNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SleecVisitor visitor) {
    visitor.visitNumName(this);
  }
