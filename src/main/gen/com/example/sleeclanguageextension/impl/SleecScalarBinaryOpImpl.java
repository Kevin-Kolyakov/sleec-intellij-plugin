...
public class SleecScalarBinaryOpImpl extends ASTWrapperPsiElement implements SleecScalarBinaryOp {

  public SleecScalarBinaryOpImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SleecVisitor visitor) {
    visitor.visitScalarBinaryOp(this);
  }
  ...
  @Override
  @NotNull
  public List<SleecScalarTerminal> getScalarTerminalList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, SleecScalarTerminal.class);
  }
