...
public class SleecScalarVarImpl extends ASTWrapperPsiElement implements SleecScalarVar {

  public SleecScalarVarImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull SleecVisitor visitor) {
    visitor.visitScalarVar(this);
  }
